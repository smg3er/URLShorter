...
# Параметры
number_of_top_sites = 200000  # Размер списка наиболее посещаемых сайтов
threads = 18   # Кол-во потоков, которые будут делать HTTP запросы
...
def api_requests(num_thread):
    ...
    retry = Retry(connect=2, backoff_factor=2, status_forcelist=[ 500, 502, 503, 504 ])
